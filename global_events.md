...
```mermaid
flowchart LR
    gulf[Persian Gulf oil exports] --> hormuz[Strait of Hormuz]
    hormuz --> ocean[Indian Ocean and world markets]
    redsea[Red Sea and Suez route] --> bab[Bab el-Mandeb]
    bab --> ocean

    hormuz -. Restricted transit shifts pressure .-> bab
    hormuz --> shortage[Fewer tanker loadings]
    bab --> risk[Alternative route also faces security risks]
    shortage --> strain[Global supply-chain stress]
    risk --> strain
